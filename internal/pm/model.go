...
type PMFileLog struct {
	...
	TenantId      *int       `gorm:"column:license_id;index:idx_tenancy_start" json:"license_id"`
}
...
type KpiAlarmTemplate struct {
	...
	TenantId   *int       `gorm:"column:license_id;uniqueIndex:idx_tenancy_name" json:"license_id"`
	UpdateTime  *time.Time `gorm:"column:update_time" json:"update_time"`
	User        *string    `gorm:"column:user;type:varchar(255)" json:"user"`
}
